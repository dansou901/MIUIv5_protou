...
.method public enter()V
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiStateMachine;->access$8500(Landroid/net/wifi/WifiStateMachine;)Ljava/lang/String;

    move-result-object v1

    #calls: Landroid/net/wifi/WifiStateMachine;->sendNetworkStateChangeBroadcast(Ljava/lang/String;)V
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$17600(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    const-string v1, "[C+W] Already registered, do not broadcast \'VERIFYING_POOR_LINK\' state"
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$2900(Landroid/net/wifi/WifiStateMachine;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Landroid/net/wifi/WifiStateMachine;->getCwRegisterState()Z
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mLastBssid:Ljava/lang/String;
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$8500(Landroid/net/wifi/WifiStateMachine;)Ljava/lang/String;
    ...
    const-string v3, "[C+W] Already registered, do not broadcast \'CONNECTED\' state"
