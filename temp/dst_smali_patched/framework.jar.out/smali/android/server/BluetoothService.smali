...
.field private static final INDEPENDENT_SHORT_PBAP_CONFIRM_TIME_ADDRESS:[Ljava/lang/String; = null
...
.field private static final MESSAGE_BT_PROFILES_STARTED_COMPLETED:I = 0x68
...
.field private static final SHORT_USER_CONFIRM_TIMEOUT_VALUE:I = 0x61a8
...
.method static constructor <clinit>()V
    ...
    const-string v1, "00:06:F7"

    aput-object v1, v0, v2

    const-string v1, "04:76:6E"

    aput-object v1, v0, v3

    const-string v1, "00:80:98"

    aput-object v1, v0, v4

    sput-object v0, Landroid/server/BluetoothService;->INDEPENDENT_SHORT_PBAP_CONFIRM_TIME_ADDRESS:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string v2, "htc.intent.action.ACTION_WFD_SESSION"
...
.method static synthetic access$300(Landroid/server/BluetoothService;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method private autoConnect()V
    ...
    :try_start_0
    iget-boolean v9, p0, Landroid/server/BluetoothService;->mAllowConnect:Z
    ...
    check-cast v8, Landroid/bluetooth/BluetoothDeviceProfileState;

    .local v8, state:Landroid/bluetooth/BluetoothDeviceProfileState;
    if-eqz v8, :cond_2
    ...
    .local v7, rmtDevName:Ljava/lang/String;
    const-string v9, "BluetoothService"
    ...
    const-string v11, "autoConnect( ), remote name = "
    ...
    const-string v10, "BENZ carkit, auto connect postpones to 30 sec later"

    invoke-static {v9, v10}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-wide/16 v9, 0x7530

    invoke-virtual {v8, v5, v9, v10}, Landroid/bluetooth/BluetoothDeviceProfileState;->sendMessageDelayed(Landroid/os/Message;J)V

    .end local v5           #msg:Landroid/os/Message;
    .end local v7           #rmtDevName:Ljava/lang/String;
    :cond_2
    :goto_1
    ...
    .end local v8           #state:Landroid/bluetooth/BluetoothDeviceProfileState;
    :catchall_0
    move-exception v9
    ...
    .restart local v7       #rmtDevName:Ljava/lang/String;
    .restart local v8       #state:Landroid/bluetooth/BluetoothDeviceProfileState;
    :cond_3
    const-string v9, "BluetoothService"

    const-string v10, "Non BENZ carkit, auto connect after 5 sec."
...
.method private declared-synchronized getMirrorDisplayStatus()Z
    .locals 3
...
.method private needShortPbapConfrimTime(Ljava/lang/String;)Z
    .locals 6
    ...
    :cond_1
    sget-object v1, Landroid/server/BluetoothService;->INDEPENDENT_SHORT_PBAP_CONFIRM_TIME_ADDRESS:[Ljava/lang/String;
...
.method private declared-synchronized updateSdpRecords()V
    ...
    const-string v3, "updateSdpRecords(): call to setBluetoothPanSdpNative(), set NAP role"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const/4 v2, 0x1

    invoke-virtual {p0, v2}, Landroid/server/BluetoothService;->setBluetoothPanSdpNative(I)V
    ...
    const-string v3, "updateSdpRecords(): call to setBluetoothPanSdpNative(), set PANU role"
...
.method public CheckPANRole()I
    ...
    sget v0, Landroid/server/BluetoothPanProfileHandler;->PanRole:I
...
.method declared-synchronized cleanupAfterFinishDisable()V
    ...
    iget-object v4, p0, Landroid/server/BluetoothService;->mProfileConnectionState:Ljava/util/HashMap;
...
.method public connectHeadset(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-direct {p0}, Landroid/server/BluetoothService;->getMirrorDisplayStatus()Z
    ...
    const-string v4, "Wireless display in active, take no action for connectHeadset"
...
.method public connectSink(Ljava/lang/String;)Z
    ...
    const-string v4, "Wireless display in active, take no action for connectSink"
...
.method public declared-synchronized disable(Z)Z
    ...
    const-string v3, "mBluetoothState is wrong!!"
...
.method declared-synchronized disconnectDevices()V
    ...
    invoke-virtual {p0}, Landroid/server/BluetoothService;->CheckPANRole()I
    ...
    const-string v4, "Reset PAN NAP state"
    ...
    const-string v4, "Reset PANu state"
...
.method public declared-synchronized enable(ZZ)Z
    ...
    const-string v3, "enable(): mIsAirplaneSensitive: "
    ...
    const-string v3, " isAirplaneToggleable(): "
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0}, Landroid/server/BluetoothService;->enableRestrictionCheck()Z
...
.method public enableRestrictionCheck()Z
    ...
    const-string v4, "checking for enable restriction..."
    ...
    :cond_0
    invoke-virtual {p0, v1}, Landroid/server/BluetoothService;->checkBTEasState(I)Z
    ...
    const-string v3, "Bluetooth enable is disallowed due to EAS policy"
    ...
    :cond_1
    invoke-virtual {p0}, Landroid/server/BluetoothService;->isBluetoothRestricted()Z
    ...
    const-string v3, "Bluetooth enable is restricted by restriction policy"
...
.method public isAudioGatewaySupported()Z
    ...
    const-string v0, "service.brcm.bt.ag_supported"
...
.method public isBluetoothTetheringRestricted()Z
    ...
    invoke-virtual {v1}, Landroid/server/BluetoothPanProfileHandler;->isBluetoothTetheringRestricted()Z
...
.method notifyIncomingPbapConnection(Ljava/lang/String;)V
    ...
    .prologue
    iget-boolean v3, p0, Landroid/server/BluetoothService;->mPbapConnectionAccessReplyReceived:Z

    if-nez v3, :cond_0

    const-string v3, "BluetoothService"

    const-string v4, "notifyIncomingPbapConnection but have pending reply not be received"
    ...
    iput-boolean v3, p0, Landroid/server/BluetoothService;->mPbapConnectionAccessReplyReceived:Z
    ...
    invoke-direct {p0, p1}, Landroid/server/BluetoothService;->needShortPbapConfrimTime(Ljava/lang/String;)Z
    ...
    const-string v4, "notifyIncomingPbapConnection detect Denso11 do shorter PBAP confirm timeout"
...
.method notifyIncomingProfileConnection(Ljava/lang/String;)V
    ...
    .prologue
    iget-boolean v3, p0, Landroid/server/BluetoothService;->mProfileConnectionAccessReplyReceived:Z

    if-nez v3, :cond_0

    const-string v3, "BluetoothService"

    const-string v4, "notifyIncomingProfileConnection but have pending reply not be received"
    ...
    iput-boolean v3, p0, Landroid/server/BluetoothService;->mProfileConnectionAccessReplyReceived:Z
...
.method declared-synchronized onCreatePairedDeviceResult(Ljava/lang/String;I)V
    ...
    const-string v2, "onCreatePairedDeviceResult: auth rejected thus re-repair once more "
...
.method public declared-synchronized sendConnectionStateChange(Landroid/bluetooth/BluetoothDevice;III)V
    ...
    const-string v3, "Release PBAP confirm timer "
...
.method public setBluetoothRestricted(Z)V
    ...
    const-string v4, "setBluetoothRestricted(): "
    ...
    const-string v3, "bluetooth_restriction"
    ...
    const-string v2, "setBluetoothRestricted(true) and current state is not off, shutoff Bluetooth"
...
.method public setBluetoothTethering(Z)V
    ...
    const-string v1, "setBluetoothTethering(): 3LM BLOCKED"
...
.method public setBluetoothTetheringRestricted(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/server/BluetoothPanProfileHandler;->setBluetoothTetheringRestricted(Z)V
...
.method public declared-synchronized setPin(Ljava/lang/String;[B)Z
    ...
    const-string v5, "setPin(): format not match, drop it"
    ...
    const-string v5, "mpinString is not null!! What\'s going on??"
...
.method public declared-synchronized setTrust(Ljava/lang/String;Z)Z
    ...
    const-string v5, "setTrust for device not in cache: "
...
.method public declared-synchronized startDiscovery()Z
    ...
    const-string v3, "Wireless display in active, take no action for startDiscovery"

    invoke-static {v2, v3}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v0, Landroid/content/Intent;

    const-string v2, "android.bluetooth.adapter.action.DISCOVERY_REFUSED"
