...
.method public static doYellowPageQuery(Landroid/content/Context;Ljava/lang/String;Lcom/android/internal/telephony/CallerInfo;Lcom/android/internal/telephony/CallerInfoAsyncQuery$OnQueryCompleteListener;ILjava/lang/Object;)Lcom/android/internal/telephony/CallerInfo;
    ...
    .line 82
    invoke-static {p0, p1, v1}, Lmiui/provider/yellowpage/YellowPageUtils;->getPhoneInfo(Landroid/content/Context;Ljava/lang/String;Z)Lmiui/provider/yellowpage/model/YellowPagePhone;

    move-result-object v7

    .line 83
    .local v7, phone:Lmiui/provider/yellowpage/model/YellowPagePhone;
    if-eqz v7, :cond_1

    .line 84
    iget-object v0, p2, Lcom/android/internal/telephony/CallerInfo;->extra:Lmiui/telephony/ExtraCallerInfo;

    iput-object v7, v0, Lmiui/telephony/ExtraCallerInfo;->ypPhone:Lmiui/provider/yellowpage/model/YellowPagePhone;

    .line 85
    invoke-virtual {v7}, Lmiui/provider/yellowpage/model/YellowPagePhone;->isYellowPage()Z
    ...
    .line 86
    invoke-static {p0, p1, v1}, Lmiui/provider/yellowpage/YellowPageImgLoader;->loadThumbnail(Landroid/content/Context;Ljava/lang/String;Z)Landroid/graphics/Bitmap;
    ...
    .line 139
    .end local v7           #phone:Lmiui/provider/yellowpage/model/YellowPagePhone;
    ...
    .line 92
    .restart local v7       #phone:Lmiui/provider/yellowpage/model/YellowPagePhone;
    :cond_1
    invoke-static {p0}, Lmiui/provider/yellowpage/YellowPageUtils;->isYellowPageEnable(Landroid/content/Context;)Z
