...
.method public getHTML5VideoResource()[Ljava/lang/String;
    ...
    .prologue
    .line 112
    sget-boolean v4, Landroid/webkit/HTML5VideoViewManager;->$assertionsDisabled:Z

    if-nez v4, :cond_0

    iget-object v4, p0, Landroid/webkit/HTML5VideoViewManager;->mUiThread:Ljava/lang/Thread;
    ...
    iget-object v4, p0, Landroid/webkit/HTML5VideoViewManager;->mProxyList:Ljava/util/ArrayList;
    ...
    .line 116
    .local v1, iter:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/webkit/HTML5VideoViewProxy;>;"
    const/4 v0, 0x1
    ...
    check-cast v4, Landroid/webkit/HTML5VideoViewProxy;

    invoke-virtual {v4}, Landroid/webkit/HTML5VideoViewProxy;->getHTML5VideoResource()Ljava/lang/String;
